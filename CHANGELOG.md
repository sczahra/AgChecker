...
- Added History tab with saved searches and scans
- Added favorites, rerun, and delete actions for history entries
- Added loading indicator and disabled actions while searching
- Added app update handling and more aggressive cache cleanup on version changes
- Kept barcode paste, image upload, and scan disclaimer for better web sharing
